...
public class PercolationStats {
    ...
    public static void main(final String[] args) {
        ...
        final PercolationStats ps = new PercolationStats(Integer.parseInt(args[0]), Integer.parseInt(args[1]));
        ...
        StdOut.println("Using Weighted Quick Union for grid size: "+ args[0] + " and "+ args[1] +" Trials "+"takes: "+ time + " Seconds.");
   }
}