...
import org.example.RevisedPercolation;
import java.awt.Font;

public class RevisedPercolationVisualizer {

    // delay in miliseconds (controls animation speed)
    private static final int DELAY = 100;

    // draw n-by-n percolation system
    public static void draw(RevisedPercolation perc, int n) {
        StdDraw.clear();
    ...
    public static void main(String[] args) {
        ...
        RevisedPercolation perc = new RevisedPercolation(n);
        draw(perc, n);
        StdDraw.show();
        StdDraw.pause(DELAY);
        while (!in.isEmpty()) {
